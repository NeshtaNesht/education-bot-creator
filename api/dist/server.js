...
const express = __webpack_require__(/*! express */ "./node_modules/express/index.js"); // const config = require("./config.json");
...
const REDIRECT_URI =  false ? 0 : 'http://127.0.0.1:3002/'; // const routes = require("./src/Routes/index");
...
app.get('/api/auth', async (req, res) => {
  console.log(CLIENT_ID, REDIRECT_URI, res.query);
  const code = req.query.code;
  await https.get(`https://oauth.vk.com/access_token?client_id=${CLIENT_ID}&client_secret=${CLIENT_SECRET}&redirect_uri=${REDIRECT_URI}&code=${code}`, responseVk => {
  ...
  }).on('error', e => {}); // res.send(`Hello world ${code}`);
});
app.listen("8080", () => {
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => "cf1eef4d7e9c6d41ba7f"
/******/ 	})();
/******/ 	
